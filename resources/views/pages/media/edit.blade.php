    ...
    <div class="flex-1 flex flex-col md:flex-row gap-5 overflow-x-auto px-2">
        <div class="w-full md:2/4 order-2 md:order-none">
            <form action="{{ route('media.update', $media->id) }}" method="POST"
                class="flex flex-col md:items-start gap-4 py-2" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="w-full">
                ...
                <div class="w-full">
                    <input type="date" name="date" value="{{ $media->date }}"
                ...
                <div class="w-full">
                    <textarea name="description" id="description" value="{{ $media->description }}"
                        ...
                        placeholder="Type description.." required contenteditable>{{ $media->description }}</textarea>
                </div>
