...
@section('content')
    <div class="flex-1 overflow-x-auto px-2">
        ...
        <form action="{{ route('information.store') }}" class="flex flex-col md:flex-row md:items-start gap-4 py-3"
                    ...
                    @forelse($informations as $number => $information)
                        <tr class="bg-white border-b transition ease-in-out duration-200 hover:bg-gray-50">
                            ...
                            <td scope="row" class="px-3 py-4">
                                <iframe class="rounded-lg" src="https://www.youtube.com/embed/{{ $information->youtube }}"
                            ...
                            <td colspan="2" class="space-y-2 px-6 py-4">
                                ...
                                <!-- Delete -->
                                <button role="button" data-modal-target="popup-modal{{ $information->id }}"
                                    data-modal-toggle="popup-modal{{ $information->id }}"
                                    class="w-full md:w-auto block md:inline text-center bg-red-600 px-2 py-1 text-sm rounded text-white"><i
                                        class="fa-solid fa-trash"></i></button>
                                <div id="popup-modal{{ $information->id }}" tabindex="-1"
                                    ...
                                    <div class="relative w-full h-full max-w-md md:h-auto">
                                        <div class="relative bg-white rounded-lg shadow">
                                            <button type="button"
                                                ...
                                                data-modal-hide="popup-modal{{ $information->id }}">
                                                <i class="fa-solid fa-xmark"></i>
                                            </button>
                                            <div class="flex flex-col p-6 text-center">
                                                ...
                                                <div class="flex justify-center gap-2">
                                                    ...
                                                    <button data-modal-hide="popup-modal{{ $information->id }}"
                                                        type="button"
