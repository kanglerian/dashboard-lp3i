...
<div class="flex items-center gap-5 md:gap-10">
    <div class="w-full md:w-2/3 space-y-5">
        ...
        <form action="{{ route('ormawa.update', $ormawa->id) }}" class="w-full space-y-2" method="POST"
            ...
            <div class="w-full">
                ...
                <input type="text" name="title" id="title" value="{{ $ormawa->title }}"
            ...
            <div class="w-full">
                ...
                <textarea name="description" id="description" value="{{ $ormawa->description }}"
                    ...
                    required>{{ $ormawa->description }}</textarea>
                <small class="mt-2 text-xs text-red-500">
