...
<div class="flex flex-col">
    <div class="flex flex-col md:flex-row items-center gap-5 py-5">
        <div class="w-full md:w-1/2 space-y-2">
            ...
            <span role="button" onclick="copyLinkAPI('/api/ormawas')"
        ...
        <form action="{{ route('ormawa.store') }}" class="w-full md:w-1/2 space-y-2" method="POST"
                ...
                @forelse($ormawas as $number => $ormawa)
                    <tr class="bg-white border-b transition ease-in-out duration-200 hover:bg-gray-50">
                        ...
                        <th scope="row" class="px-6 py-4">
                            <img loading="lazy" src="{{ asset($ormawa->image) }}" class="w-32 rounded">
                        </th>
                        ...
                        <td colspan="2" class="space-y-2 px-6 py-4">
                            ...
                            <!-- Delete -->
                            <button role="button"
                            onclick="event.preventDefault(); deleteRecord('{{ $ormawa->id }}')"
