...
class DataPkmUPPMController extends Controller
{
    /**
    ...
    {
        $data_uppms = DataUPPM::orderBy('year','desc')->where('type','PKM')->get();
        return view('pages.uppm.data-pkm.index')->with([
    ...
    public function edit($id)
    {
        ...
        return view('pages.uppm.data-pkm.edit')->with([
            'data_uppm' => $data_uppm,
        ]);
    }
