...
class LuaranPenelitianUPPMController extends Controller
{
    /**
    ...
    {
        $luaran_uppms = LuaranUPPM::orderBy('year','desc')->where('type','Penelitian')->get();
        return view('pages.uppm.luaran-penelitian.index')->with([
    ...
    public function edit($id)
    {
        ...
        return view('pages.uppm.luaran-penelitian.edit')->with([
